Shader "Nature/Wind Leaves" 
{
	...
	SubShader
	{
		...
		void OptimizedSinCos(float4 val, out float4 s, out float4 c) 
		{
		...
		void vert(inout appdata_full v, out Input o) 
		{
			...
			float3 waveMove = float3(dot(s, _waveXmove), 0, dot(s, _waveZmove));
