...
namespace BoneBox.UI
{
	public static class RectTransformUtility
	{
		...
		/// Works by checking if each bounding box corner of this RectTransform is inside the cameras screen space view frustum.
		/// </summary>
		...
		/// Works by checking if any bounding box corner of this RectTransform is inside the cameras screen space view frustum.
		/// </summary>
